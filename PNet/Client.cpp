...
namespace PNet {
	...
	bool PNet::Client::Connect(IPEndpoint ip) {
		isConnected = false;
	...
	bool PNet::Client::IsConnected() {
		return isConnected;
	}

	bool PNet::Client::Frame() {
	...
	bool PNet::Client::ProcessPacket(std::shared_ptr<Packet> packet) {
		std::cout << "Packet received with size: " << packet->buffer.size() << std::endl;
		return true;
	}

	void PNet::Client::OnConnect() {
		std::cout << "Successfully connected!" << std::endl;
	}

	void PNet::Client::OnConnectFail() {
		std::cout << "Failed to connect" << std::endl;
	}

	void PNet::Client::OnDisconnect(std::string reason) {
